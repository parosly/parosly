    ...
    responses={
        ...
        400: {
            ...
            "content": {
                "application/json": {
                    "example": [
                        {"status": "error", "message": "Additional properties are not allowed ('rule' was unexpected)"}
                    ]
                }
            },
        },
...
@router.put(
    ...
    responses={
        201: {
            "description": "Created",
            "content": {
                "application/json": {"example": [{"status": "success", "message": "The rule was created successfully"}]}
            },
        },
        400: {
            "description": "Bad Request",
        ...
        409: {
            ...
            "content": {
                "application/json": {"example": [{"status": "error", "message": "The requested file already exists"}]}
            },
        },
        500: {
            "description": "Internal Server Error",
...
async def update(
    ...
    if file and os.path.exists(f"{rule_path}/{file}"):
        if recreate.lower() == "true":
            ...
            resp = {"status": "error", "message": "The requested file already exists.", "file": file}
    else:
        response.status_code, resp = prom.create_rule(r, file)
...
@router.delete(
    ...
    responses={
        ...
        404: {
            ...
            "content": {"application/json": {"example": [{"status": "error", "message": "File not found"}]}},
        },
        500: {
            "description": "Internal Server Error",
            "content": {
